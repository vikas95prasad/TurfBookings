...
class TurfDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turf_detail" do
    assert_difference('TurfDetail.count') do
      post turf_details_url, params: { turf_detail: { address: @turf_detail.address, name: @turf_detail.name, phone: @turf_detail.phone } }
    end
  ...
  test "should update turf_detail" do
    patch turf_detail_url(@turf_detail), params: { turf_detail: { address: @turf_detail.address, name: @turf_detail.name, phone: @turf_detail.phone } }
